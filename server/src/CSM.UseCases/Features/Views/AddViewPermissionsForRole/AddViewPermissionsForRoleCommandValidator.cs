...
internal sealed class AddViewPermissionsForRoleCommandValidator : AbstractValidator<AddViewPermissionsForRoleCommand>
{
    public AddViewPermissionsForRoleCommandValidator()
    {
        RuleFor(c => c.RoleId)
            .NotEmpty().WithErrorCode(ErrorCode.RoleIdEmpty.ToString());
